...
vertice CurvaEsquerda::getOrigemE()
{
    return this->origemE;
}

vertice CurvaEsquerda::getOrigemD()
{
    return this->origemD;
}

void CurvaEsquerda::atualizaPontosConstrucao()
{
...
void CurvaEsquerda::iniciaPontosConstrucao()
{
...
void CurvaEsquerda::drawCurvaEsquerda()
{
...
void CurvaEsquerda::drawCurvaDireita()
{
    for(int i=0; i<nPontos-1; i++)
    {
        glBegin(GL_QUADS);
...
float CurvaEsquerda::getRaio()
{
    return this->raio;
}

vertice CurvaEsquerda::getNormal(vertice v)
{
...
void CurvaEsquerda::encontraDoisPontosMaisProximosE(vertice p, vertice* v1, vertice* v2)
{
...
void CurvaEsquerda::encontraDoisPontosMaisProximosD(vertice p, vertice* v1, vertice* v2)
{
    vertice pontoMedio, proxPontoMedio;
    float menorDistancia;
    int i;
